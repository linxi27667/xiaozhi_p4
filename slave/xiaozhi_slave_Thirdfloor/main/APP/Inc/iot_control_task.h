 ...
 * - 定时刷新 GPIO 输出
 *
 * 设备配置：3灯 + 3继电器 + 3舵机 + 烟雾传感器 + 雨滴传感器 + 求助按键
 *
 * 架构原则：
 * - 设备状态全部使用枚举类型（易读、易扩展）
 * - 枚举定义在此处，供其他模块引用
...
#define LIGHT_2_CHINESE   "三楼灯2"
#define LIGHT_3_CHINESE   "三楼灯3"

#define RELAY_1_CHINESE   "三楼继电器1"
#define RELAY_2_CHINESE   "三楼继电器2"
#define RELAY_3_CHINESE   "三楼继电器3"
