 ...
 * @return true when the MQTT client accepts the publish, false otherwise
 */
bool mqtt_send_command(uint8_t floor_id, uint8_t cmd_type, uint8_t gpio_index, uint8_t value);
